...
export class BodyDropDefine {
  ...
  @Expose() public extraRareArmsArr: string[] | undefined = undefined;
  ...
  public toXml(): string {
    ...
    if (this.extraRareArmsArr && this.extraRareArmsArr.length > 0) xml += ` extraRareArmsArr="${this.extraRareArmsArr.join(",")}"`;
    xml += ` />`;
