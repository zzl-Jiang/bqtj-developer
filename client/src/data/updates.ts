...
// 配置系统重构与关卡指令优化v0.6.4更新内容
const V064_BLOCKS: LogBlock[] = [
...
// 属性补全与编辑器优化v0.6.1更新内容
const V061_BLOCKS: LogBlock[] = [
...
// 剧情对话模块与系统元化v0.4.0更新内容
const V040_BLOCKS: LogBlock[] = [
...
// 深度关卡编辑系统上线v0.3.1更新内容
const V031_BLOCKS: LogBlock[] = [
...
// 可视化编辑器初具雏形v0.2.0更新内容
const V020_BLOCKS: LogBlock[] = [
